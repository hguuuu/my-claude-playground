...
1. **Study:** current phase + criteria passed/open (from `skills.md`), predictions due/overdue, 未考 count, streak/last-review date.
...
3. Generate the first root `STATUS.md` (both engines, per §8.4).
